...
update_status ModuleSceneIntro::Update(float dt)
{
	...
	CreateCube(100, 1, 10, -15, 48.5, 50, 0, 0, 0, 0, 0.42, 0.42, 0.42);
	CreateCube(10, 1, 30, 30, 48.5, 30, 0, 0, 0, 0, 0.42, 0.42, 0.42);
	CreateCube(100, 1, 10, -20, 25, 30, 0, 0, 1, 20, 0.42, 0.42, 0.42);
